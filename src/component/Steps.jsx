  ...
  return (
    <div className="mx-4 lg:mx-44 py-20 xl:py-40">
      ...
      <div className="flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
        <div className="flex items-start gap-4 bg-white hover:border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500 cursor-pointer">
